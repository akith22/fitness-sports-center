  ...
  return (
    <div id="home" className="w-full pt-[64px]">
      <div className="p-[0px] sm:p-[16px] lg:p-[40px]">
        ...
        >
          <motion.div
            className="flex flex-col gap-[16px] max-w-[768px] z-10 w-full"
          ...
          <motion.div
            className="flex flex-wrap gap-[16px] justify-center z-10 mt-[16px]"
          ...
          <motion.div
            className="absolute bottom-[32px] left-[0px] right-[0px] flex justify-center gap-[40px] text-[#94a3b8] text-[12px] leading-[16px] tracking-[0.1em] uppercase hidden sm:flex"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
